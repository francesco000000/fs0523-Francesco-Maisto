...
*/
  function isThisAnEmail(str) {
    if (str === "[A-z0-9\.\+_-]+@[A-z0-9\._-]+\.[A-z]{2,6}") {
        return true
    } else{
      return false
    }
...
function sumAllTheYears (obj) {
  return obj.reduce((acc, curr) => acc + parseInt(curr.Year), 0)
}
...
*/
function trovaLink() {
  let a = document.querySelectorAll("a").style.backgrounColor="red"
